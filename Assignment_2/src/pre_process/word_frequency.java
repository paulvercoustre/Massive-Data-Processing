...
public class word_frequency extends Configured implements Tool {
   public static void main(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      int res = ToolRunner.run(new Configuration(), new word_frequency(), args);
   ...
   public int run(String[] args) throws Exception {
      ...
      job.setJarByClass(word_frequency.class);
